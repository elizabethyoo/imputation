...
def plot_feature_importance(feature_importance_df, config_data, output_dir='src/output'):
    """Create and save a bar plot of feature importance"""
    # Set the style
    plt.style.use('ggplot')

    # Create figure with specified size
    fig_size = config_data['visualization']['figure_size']
    ...
    plt.title('Feature Importance in Random Forest Model',
              fontsize=config_data['visualization']['font_size'])
    plt.xlabel(
        'Importance', fontsize=config_data['visualization']['font_size']-2)
    plt.ylabel(
        'Features', fontsize=config_data['visualization']['font_size']-2)
